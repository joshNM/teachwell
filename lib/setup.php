...
function assets() {
  ...
  wp_enqueue_style( 'googleroundedfont', 'https://fonts.googleapis.com/css?family=Varela+Round');


  wp_enqueue_style( 'slicknavcss', 'https://fonts.googleapis.com/css?family=Maven+Pro' );
